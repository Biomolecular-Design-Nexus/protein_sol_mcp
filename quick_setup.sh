#!/bin/bash
#===============================================================================
# Protein-Sol MCP Quick Setup Script
#===============================================================================
# This script sets up the complete environment for Protein-Sol MCP server.
...
echo -e "${BLUE}"
echo "=============================================="
echo "    Protein-Sol MCP Quick Setup Script       "
echo "=============================================="
echo -e "${NC}"
...
if [ "$SKIP_ENV" = true ]; then
    ...
    info "Creating conda environment with Python ${PYTHON_VERSION} and pandas..."
    $CONDA_CMD create -p "$ENV_DIR" python=${PYTHON_VERSION} pandas -y
fi
...
"${ENV_DIR}/bin/python" -c "import fastmcp; import loguru; import pandas; print('Core packages OK')" && success "Core packages verified" || error "Package verification failed"
...
echo "  claude mcp add protein_sol -- ${ENV_DIR}/bin/python ${SCRIPT_DIR}/src/server.py"
echo ""
